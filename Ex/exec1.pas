...
val1,val2,val3,val4,val5,val6,val7,avg:Double;
...
begin
 ...
 with Form1 do
 begin
 StringGrid1.Cells[1,0]:='2008年4月真题';
 StringGrid1.Cells[2,0]:='2008年9月真题';
 StringGrid1.Cells[3,0]:='2009年3月真题';
 StringGrid1.Cells[4,0]:='2009年9月真题';
 StringGrid1.Cells[5,0]:='2010年3月真题';
 StringGrid1.Cells[6,0]:='2010年9月真题';
 StringGrid1.Cells[7,0]:='2011年3月真题';
 StringGrid1.Cells[8,0]:='历年平均';

  StringGrid1.RowCount:=cou1+cou2+cou3+cou4+3;
  StringGrid1.ColCount:=9;
  for ccol:=1 to 8 do begin
  ...
  begin
   ...
   begin
    ...
    val1:=aq1.fieldbyname('2008年上半年分值比例').asfloat; val1:=val1*100;
    cells[1,crow]:=FloattoStrF(val1,ffNumber,10,2)+'%';//倒数第2位是精度，此处设为10
    val2:=aq1.fieldbyname('2008年下半年分值比例').asfloat; val2:=val2*100;
    cells[2,crow]:=FloattoStrF(val2,ffNumber,10,2)+'%';
    val3:=aq1.fieldbyname('2009年上半年分值比例').asfloat; val3:=val3*100;
    cells[3,crow]:=FloattoStrF(val3,ffNumber,10,2)+'%';
    val4:=aq1.fieldbyname('2009年下半年分值比例').asfloat; val4:=val4*100;
    cells[4,crow]:=FloattoStrF(val4,ffNumber,10,2)+'%';
    val5:=aq1.fieldbyname('2010年上半年分值比例').asfloat; val5:=val5*100;
    cells[5,crow]:=FloattoStrF(val5,ffNumber,10,2)+'%';
    val6:=aq1.fieldbyname('2010年下半年分值比例').asfloat; val6:=val6*100;
    cells[6,crow]:=FloattoStrF(val6,ffNumber,10,2)+'%';
    val7:=aq1.fieldbyname('2011年上半年分值比例').asfloat; val7:=val7*100;
    cells[7,crow]:=FloattoStrF(val7,ffNumber,10,2)+'%';
    avg:=(val1+val2+val3+val4+val5+val6+val7)/7;
    Cells[8,crow]:=FloatToStrF(avg,ffNumber,10,2)+'%';
    aq2.sql.clear;
    ...
    begin
     ...
     val1:=aq2.fieldbyname('2008年上半年分值比例').asfloat; val1:=val1*100;
     cells[1,crow]:=FloattoStrF(val1,ffNumber,10,2)+'%';//倒数第2位是精度，此处设为10
     val2:=aq2.fieldbyname('2008年下半年分值比例').asfloat; val2:=val2*100;
     cells[2,crow]:=FloattoStrF(val2,ffNumber,10,2)+'%';
     val3:=aq2.fieldbyname('2009年上半年分值比例').asfloat; val3:=val3*100;
     cells[3,crow]:=FloattoStrF(val3,ffNumber,10,2)+'%';
     val4:=aq2.fieldbyname('2009年下半年分值比例').asfloat; val4:=val4*100;
     cells[4,crow]:=FloattoStrF(val4,ffNumber,10,2)+'%';
     val5:=aq2.fieldbyname('2010年上半年分值比例').asfloat; val5:=val5*100;
     cells[5,crow]:=FloattoStrF(val5,ffNumber,10,2)+'%';
     val6:=aq2.fieldbyname('2010年下半年分值比例').asfloat; val6:=val6*100;
     cells[6,crow]:=FloattoStrF(val6,ffNumber,10,2)+'%';
     val7:=aq2.fieldbyname('2011年上半年分值比例').asfloat; val7:=val7*100;
     cells[7,crow]:=FloattoStrF(val7,ffNumber,10,2)+'%';
     avg:=(val1+val2+val3+val4+val5+val6+val7)/7;
     Cells[8,crow]:=FloatToStrF(avg,ffNumber,10,2)+'%';
     aq3.sql.clear;
     ...
     begin
       ...
       val1:=aq3.fieldbyname('2008年上半年分值比例').asfloat; val1:=val1*100;
       cells[1,crow]:=FloattoStrF(val1,ffNumber,10,2)+'%';//倒数第2位是精度，此处设为10
       val2:=aq3.fieldbyname('2008年下半年分值比例').asfloat; val2:=val2*100;
       cells[2,crow]:=FloattoStrF(val2,ffNumber,10,2)+'%';
       val3:=aq3.fieldbyname('2009年上半年分值比例').asfloat; val3:=val3*100;
       cells[3,crow]:=FloattoStrF(val3,ffNumber,10,2)+'%';
       val4:=aq3.fieldbyname('2009年下半年分值比例').asfloat; val4:=val4*100;
       cells[4,crow]:=FloattoStrF(val4,ffNumber,10,2)+'%';
       val5:=aq3.fieldbyname('2010年上半年分值比例').asfloat; val5:=val5*100;
       cells[5,crow]:=FloattoStrF(val5,ffNumber,10,2)+'%';
       val6:=aq3.fieldbyname('2010年下半年分值比例').asfloat; val6:=val6*100;
       cells[6,crow]:=FloattoStrF(val6,ffNumber,10,2)+'%';
       val7:=aq3.fieldbyname('2011年上半年分值比例').asfloat; val7:=val7*100;
       cells[7,crow]:=FloattoStrF(val7,ffNumber,10,2)+'%';
       avg:=(val1+val2+val3+val4+val5+val6+val7)/7;
       Cells[8,crow]:=FloatToStrF(avg,ffNumber,10,2)+'%';
       aq4.sql.clear;
       ...
       begin
        ...
        val1:=aq4.fieldbyname('2008年上半年分值比例').asfloat; val1:=val1*100;
        cells[1,crow]:=FloattoStrF(val1,ffNumber,10,2)+'%';//倒数第2位是精度，此处设为10
        val2:=aq4.fieldbyname('2008年下半年分值比例').asfloat; val2:=val2*100;
        cells[2,crow]:=FloattoStrF(val2,ffNumber,10,2)+'%';
        val3:=aq4.fieldbyname('2009年上半年分值比例').asfloat; val3:=val3*100;
        cells[3,crow]:=FloattoStrF(val3,ffNumber,10,2)+'%';
        str          :=FloattoStrF(val3,ffNumber,10,2)+'%';
        val4:=aq4.fieldbyname('2009年下半年分值比例').asfloat; val4:=val4*100;
        cells[4,crow]:=FloattoStrF(val4,ffNumber,10,2)+'%';
        val5:=aq4.fieldbyname('2010年上半年分值比例').asfloat; val5:=val5*100;
        cells[5,crow]:=FloattoStrF(val5,ffNumber,10,2)+'%';
        val6:=aq4.fieldbyname('2010年下半年分值比例').asfloat; val6:=val6*100;
        cells[6,crow]:=FloattoStrF(val6,ffNumber,10,2)+'%';
        val7:=aq4.fieldbyname('2011年上半年分值比例').asfloat; val7:=val7*100;
        cells[7,crow]:=FloattoStrF(val7,ffNumber,10,2)+'%';
        avg:=(val1+val2+val3+val4+val5+val6+val7)/7;
        Cells[8,crow]:=FloatToStrF(avg,ffNumber,10,2)+'%';
        aq4.Next;
