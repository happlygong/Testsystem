...
begin
  ...
  s1:='您将要分析的是：  '+#13+#13+'    ';
  table[0]:='二级C语言一级考点内容表';
  table[1]:='二级VB一级考点内容表';
  table[2]:='二级VF一级考点内容表';
  table[3]:='二级Access一级考点内容表';
  table[4]:='三级网络技术一级考点内容表';
  for i:=0 to 4 do
   begin
  ...
  case i of
     0:begin
       TableName[0]:='二级C语言一级考点内容表';
       TableName[1]:='二级C语言二级考点内容表';
       TableName[2]:='二级C语言三级考点内容表';
       TableName[3]:='二级C语言四级考点内容表';s2:='二级C语言';
       is2c:=True;
       end;
     1:begin
       TableName[0]:='二级VB一级考点内容表';
       TableName[1]:='二级VB二级考点内容表';
       TableName[2]:='二级VB三级考点内容表';
       TableName[3]:='二级VB四级考点内容表';s2:='二级VB';
       end;
     2:begin
       TableName[0]:='二级VF一级考点内容表';
       TableName[1]:='二级VF二级考点内容表';
       TableName[2]:='二级VF三级考点内容表';
       TableName[3]:='二级VF四级考点内容表';s2:='二级VF';
       end;
     3:begin
       TableName[0]:='二级Access一级考点内容表';
       TableName[1]:='二级Access二级考点内容表';
       TableName[2]:='二级Access三级考点内容表';
       TableName[3]:='二级Access四级考点内容表';s2:='二级Access';
       end;
     4:begin
       TableName[0]:='三级网络技术一级考点内容表';
       TableName[1]:='三级网络技术二级考点内容表';
       TableName[2]:='三级网络技术三级考点内容表';
       TableName[3]:='三级网络技术四级考点内容表';s2:='三级网络技术';
       is3ji:=True;
       end;
     else
...
begin
 ...
 begin
  ...
  begin
    ...
    v.range['a'+inttostr(row1)+':j'+inttostr(row1)].interior.colorindex:=24;
    str:= aq1.fieldbyname('一级考点名称').asstring;
...
begin
 ...
 //btn2.Enabled:=false;
    if not(chk1.Checked or chk2.Checked or chk3.Checked or
           ...
           chk7.Checked or chk8.Checked or chk9.Checked) then
           begin
...
//      field4:='*';
{    if is2c then begin
      zt[1]:='2008年上半年分值比例';zt[2]:='2008年下半年分值比例';
      zt[3]:='2009年上半年分值比例';zt[4]:='2009年下半年分值比例';
      zt[5]:='2010年上半年分值比例';zt[6]:='2010年下半年分值比例';
      zt[7]:='2011年上半年分值比例';MuX:=7;
      field1:=' 编号,一级考点名称,[2008年上半年分值比例],[2008年下半年分值比例],[2009年上半年分值比例],[2009年下半年分值比例],[2010年上半年分值比例],[2010年下半年分值比例],[2011年上半年分值比例] ';
      field2:=' 编号,二级考点名称,[2008年上半年分值比例],[2008年下半年分值比例],[2009年上半年分值比例],[2009年下半年分值比例],[2010年上半年分值比例],[2010年下半年分值比例],[2011年上半年分值比例] ';
      field3:=' 编号,三级考点名称,[2008年上半年分值比例],[2008年下半年分值比例],[2009年上半年分值比例],[2009年下半年分值比例],[2010年上半年分值比例],[2010年下半年分值比例],[2011年上半年分值比例] ';
      field4:=' 编号,四级考点名称,[2008年上半年分值比例],[2008年下半年分值比例],[2009年上半年分值比例],[2009年下半年分值比例],[2010年上半年分值比例],[2010年下半年分值比例],[2011年上半年分值比例] ';
      end
      else begin
      zt[1]:='2007年上半年分值比例';zt[2]:='2007年下半年分值比例';
      zt[3]:='2008年上半年分值比例';zt[4]:='2008年下半年分值比例';
      zt[5]:='2009年上半年分值比例';zt[6]:='2009年下半年分值比例';
      zt[7]:='2010年上半年分值比例';zt[8]:='2010年下半年分值比例';
      zt[9]:='2011年上半年分值比例';//MuX:=9;
...
//      field4:='*';
    if is2c then begin
      ...
      zt[7]:='2010年上半年分值比例';zt[8]:='2010年下半年分值比例';
      zt[9]:='2011年上半年分值比例';MuX:=9;
      field1:=' 编号,一级考点名称,[2007年上半年分值比例],[2007年下半年分值比例],[2008年上半年分值比例],[2008年下半年分值比例],[2009年上半年分值比例],[2009年下半年分值比例],[2010年上半年分值比例],[2010年下半年分值比例],[2011年上半年分值比例] ';
      field2:=' 编号,二级考点名称,[2007年上半年分值比例],[2007年下半年分值比例],[2008年上半年分值比例],[2008年下半年分值比例],[2009年上半年分值比例],[2009年下半年分值比例],[2010年上半年分值比例],[2010年下半年分值比例],[2011年上半年分值比例] ';
      field3:=' 编号,三级考点名称,[2007年上半年分值比例],[2007年下半年分值比例],[2008年上半年分值比例],[2008年下半年分值比例],[2009年上半年分值比例],[2009年下半年分值比例],[2010年上半年分值比例],[2010年下半年分值比例],[2011年上半年分值比例] ';
      field4:=' 编号,四级考点名称,[2007年上半年分值比例],[2007年下半年分值比例],[2008年上半年分值比例],[2008年下半年分值比例],[2009年上半年分值比例],[2009年下半年分值比例],[2010年上半年分值比例],[2010年下半年分值比例],[2011年上半年分值比例] ';
      end;
    aq1:=TADOQuery.Create(nil);
    aq1.Connection:=DBe.DM.con1;
    aq2:=TADOQuery.Create(nil);
...
begin
  ...
  '出错了',MB_OK or MB_ICONWARNING);
    ...
    {Application.Restore;
    Application.BringToFront;}
    field1:=' 一级考点名称 ';con1:='一级考点内容';
    field2:=' 二级考点名称 ';con2:='二级考点内容';
    field3:=' 三级考点名称 ';con3:='三级考点内容';
    field4:=' 四级考点名称 ';con4:='四级考点内容';
    aq1:=TADOQuery.Create(nil);
    aq1.Connection:=DBe.DM.con1;
    aq2:=TADOQuery.Create(nil);
    aq2.connection:=DBE.dm.con1;
 ...
 begin
  ...
  begin
    ...
    //edt1.lines.Append(aq1.fieldbyname('一级考点内容').asstring);

    aq2.sql.clear;
    aq2.sql.add('select '+field2+','+con2+' from '+TableName[1]+' where [二级考点所属一级考点ID]='+inttostr(i)+' order by 二级考点ID ASC');
    aq2.open;
    cou2:=aq2.RecordCount;
    ...
    begin
      ...
      edt1.lines.Append(aq2.fieldbyname('二级考点内容').asstring);
     aq3.sql.clear;
     aq3.sql.add('select '+field3+', '+con3+' from '+TableName[2]+' where ([三级考点所属一级考点ID]='+inttostr(i)+
                ') and ([三级考点所属二级考点ID]='+inttostr(j)+') order by 三级考点ID ASC');
     aq3.open;
     cou3:=aq3.RecordCount;
     ...
     begin
       ...
       edt1.lines.Append(aq3.fieldbyname('三级考点内容').asstring);

       aq4.sql.clear;
       aq4.sql.add('select '+field4+','+con4+' from '+TableName[3]+' where ([四级考点所属一级考点ID]='+inttostr(i)+
                ') and ([四级考点所属二级考点ID]='+inttostr(j)+
                ') and ([四级考点所属三级考点ID]='+inttostr(k)+
                ') order by 四级考点ID ASC');
       aq4.open;
       ...
       begin
         ...
         edt1.lines.Append(aq4.fieldbyname('四级考点内容').asstring);
 ...
 edt1.Lines.SaveToFile(TableName[0]+'.rtf');
 caption:='完成';
